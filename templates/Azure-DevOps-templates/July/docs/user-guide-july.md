...
The July release needs broader permissions than the earlier manual scripts because it creates or updates the project/process, materializes inherited/system work item types, updates layouts, configures teams/areas/backlogs, checks the DevLabs multivalue control extension, and imports work items.
